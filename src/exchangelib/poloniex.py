...
class poloniex:
	...
	def api_query(self, uri, type='GET', payload=None):
	...
	# Places a buy order in a given market. Datarequired POST parameters are
	# "currencyPair", "rate", and "amount". If successful, the method will
	...
	# Places a sell order in a given market. Datarequired POST parameters are
	# "currencyPair", "rate", and "amount". If successful, the method will
	# return the order number.
	...
	# Cancels an order you have placed in a given market. Datarequired POST
	# parameters are "currencyPair" and "orderNumber".
	...
	# be enabled for your API key. Datarequired POST parameters are "currency",
	# "amount", and "address". Sample output: {"response":"Withdrew 2398
	# NXT."}
